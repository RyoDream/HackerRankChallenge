 ...
 *
 * Note: Because we are writing multiple classes in the same file,
 * do not use an access modifier (e.g.: public) in your class declaration (or your code will not compile);
 * however, you must use the public access modifier
 * before your method declaration for it to be accessible by the other classes in the file.
 *
 * Input Format
