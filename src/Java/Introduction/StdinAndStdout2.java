 ...
 *
 * Most of the problems on HackerRank require reading input from stdin (standard input)
 * and writing output to stdout (standard output).
 *
 ...
 * Int: 42
 *
 * Note: Do not concern yourself with formatting the output at this time;
 * the goal here is to acquaint yourself with stdin and stdout.
 */
