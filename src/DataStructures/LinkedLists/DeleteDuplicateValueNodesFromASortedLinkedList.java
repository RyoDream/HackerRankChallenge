 ...
 * In common abstract data structure scenarios,
 ...
 *
 * Input Format
 * You have to complete the Node* RemoveDuplicates(Node* head) method
 * which takes one argument - the head of the sorted linked list.
