 ...
 * and the position at which the integer must be inserted. You should NOT read any input from stdin/console.
 * position will always be between 0 and the number of the elements in the list (inclusive).
 *
 * Output Format
